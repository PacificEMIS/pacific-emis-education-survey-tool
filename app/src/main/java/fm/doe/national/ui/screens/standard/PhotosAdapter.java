...
public class PhotosAdapter extends BaseAdapter<String> {
    ...
    class PhotoViewHolder extends ViewHolder {
        ...
        @OnClick({R.id.imageview_delete_button, R.id.imageview_photo})
        public void onViewClick(View v) {
            switch (v.getId()) {
                case R.id.imageview_delete_button:
                    if (callback != null) callback.onRemovePhotoClicked(parentSubCriteria, getItem());
                    break;
                case R.id.imageview_photo:
                    if (callback != null) callback.onPhotoClicked(v, getItem());
                    break;
            }
        }
    }
