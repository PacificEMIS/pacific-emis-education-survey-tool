...
public class UploadWorker extends RxWorker {
    ...
    private final Serializer<Survey> serializer = MicronesiaApplication.getInjection().getCoreComponent().getSurveySerializer();
    private final CloudRepository cloudRepository = MicronesiaApplication.getInjection().getAppComponent().getCloudRepository();
